document.addEventListener("DOMContentLoaded", function () {
  ...
  function startStarfield() {
    ...
    const frames = [
      ...
      "Kahit wala akong Spotify Premium, <br> Ikaw pa rin ang laging kanta ng puso ko. 💞",
      "Kahit maging senior citizens na tayo, <br> ako pa rin ang maglalagay ng salonpas sa likod mo. 😆👵👴",
      "Kahit kulubot na tayo at puti na buhok natin, <br> ang pagmamahal ko sa'yo, fresh pa rin parang bagong ligo. 🚿💞",
      "Hindi man tayo perfect, pero parang Jollibee, <br> Langhap-sarap ang love ko sa’yo—panghabambuhay! 🍗💖",
      "Kahit na minsan hindi tayo nagkakaintindihan, <br> mas pipiliin ko pa rin ang buhay na kasama ka",
      "Sa lahat ng away-bati natin, lagi pa rin akong babalik sa yakap mo. 🤗❤️",
      "At sa dulo ng lahat, ikaw at ikaw pa rin… <br> Ang forever best decision ko.",
